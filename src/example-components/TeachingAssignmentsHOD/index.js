...
export default function LivePreviewExample() {
    const onChange = (e) => {
      ...
      const [sched,setStatesched]=React.useState({ 
     ...
     .post('http://localhost:3001/hod/viewTeachingAssignments',body, {
     headers: {
    ...
    <Fragment>
        ...
        <TextField id="outlined-basic" name="course" label="Teaching Assignments By Course" variant="outlined" onChange={onChange} />
        <Button variant="outlined" type="submit" hight='10' onClick={onClick} >Filter</Button>
        </form>
